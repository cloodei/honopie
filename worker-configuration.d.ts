/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: d959a96a0a10617073c8abdfc4871f56)
...
declare namespace Cloudflare {
	interface Env {
		...
		JWT_EXPIRATION_NUM: string;
		REFRESH_JWT_EXPIRATION: string;
		REFRESH_EXPIRATION_NUM: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "MQTT_CLUSTER_URL" | "MQTT_USERNAME" | "MQTT_PASSWORD" | "JWT_SECRET" | "JWT_EXPIRATION" | "JWT_EXPIRATION_NUM" | "REFRESH_JWT_EXPIRATION" | "REFRESH_EXPIRATION_NUM" | "REFRESH_HASH_SECRET" | "CLOUDFLARE_API_TOKEN" | "CLOUDFLARE_ACCOUNT_ID">> {}
}
